...
import {UsersListPagination} from '../components/pagination/QuotationsListPagination'
  ...
  return (
    <KTCardBody className='py-4'>
      <div className='table-responsive'>
        <table
          id='kt_table_users'
          className='table table-xxl align-middle table-row-dashedt table-hover fs-6 gy-7 dataTable no-footer'
          {...getTableProps()}
        >
          <thead>
            <tr className='text-start text-muted fw-bolder fs-7 text-uppercase gs-0'>
              {headers.map((column: ColumnInstance<Quotations>) => (
