...
import { QuotationsInStatusCell } from './QuotationsInStatusCell'
import { QuotationsSelectionHeader } from './QuotationsInStatusHeader'
...
const usersColumns: ReadonlyArray<Column<Quotations>> = [
  ...
  {
    Header: (props) => (
      <QuotationsCustomHeader tableProps={props} title='Out Status' className='min-w-150px cursor-pointer text-hover-primary' />
    ),
